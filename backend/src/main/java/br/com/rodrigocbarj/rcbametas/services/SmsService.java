...
public class SmsService {
    ...
    public void sendSms(Long saleId) {
        ...
        String bodyMsg = "Venda #" + sale.getId() + ":\n" +
                        sale.getSellerName() + " realizou R$ " + String.format("%.2f", sale.getAmount()) +
                        " em vendas, reportado no dia " + date;
        ...
        Message message = Message.creator(to, from, bodyMsg).create();
